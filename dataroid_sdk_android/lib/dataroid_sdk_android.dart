/// Android implementation of the Dataroid SDK platform interface.
library dataroid_sdk_android;
...
/// Android implementation of [DataroidSdkPlatform].
class DataroidSdkAndroid extends DataroidSdkPlatform {
  /// Registers this class as the default instance of [DataroidSdkPlatform].
  static void registerWith() {
    DataroidSdkPlatform.instance = DataroidSdkAndroid();
  }
  ...
  Future<bool> init(DataroidConfig config) async {
    try {
      // Android init is handled on the native side during app startup
  ...
  Future<bool> updateApmConfig({bool? recordCollectionEnabled, bool? apmAutoCaptureEnabled, int? recordStorageLimit}) async {
    try {
      ...
      if (recordCollectionEnabled != null) {
        args['recordCollectionEnabled'] = recordCollectionEnabled;
      }
      if (apmAutoCaptureEnabled != null) {
        args['apmAutoCaptureEnabled'] = apmAutoCaptureEnabled;
      }
      if (recordStorageLimit != null) {
        args['recordStorageLimit'] = recordStorageLimit;
      }
  ...
  Future<bool> updateComponentInteractionConfig({
    ...
    try {
      ...
      if (autoCollectingEnabled != null) {
        args['autoCollectingEnabled'] = autoCollectingEnabled;
      }
      if (debounceThreshold != null) {
        args['debounceThreshold'] = debounceThreshold;
      }
      if (sensitiveViewLabelList != null) {
        args['sensitiveViewLabelList'] = sensitiveViewLabelList;
      }
      if (sensitiveComponentSelectorList != null) {
        args['sensitiveComponentSelectorList'] = sensitiveComponentSelectorList;
      }
