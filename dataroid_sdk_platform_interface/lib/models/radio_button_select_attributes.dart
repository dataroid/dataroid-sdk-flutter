/*
 * 
 * radio_button_select_attributes.dart
...
class RadioButtonSelectAttributes extends ComponentAttributes {
  final String? label;
  final String? groupName;
  final String? elementType;
  final String? elementName;

  RadioButtonSelectAttributes({
    this.label,
    this.groupName,
    this.elementType,
    this.elementName,
  ...
  factory RadioButtonSelectAttributes.fromJson(Map<String, dynamic> json) {
    return RadioButtonSelectAttributes(
      label: json[ArgumentName.label],
      groupName: json[ArgumentName.groupName],
  ...
  Map<String, dynamic> get toJSON => {
        ...
        ArgumentName.groupName: groupName,
  ...
  @override
  String toString() => 'RadioButtonSelectAttributes(className: $className'
