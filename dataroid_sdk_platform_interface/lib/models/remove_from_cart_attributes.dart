/*
 * 
 * remove_from_cart_attributes.dart
...
class RemoveFromCartAttributes extends CommerceEvent {
  final Product product;
  final int? value;
  final int? totalCartValue;

  RemoveFromCartAttributes({
  ...
  factory RemoveFromCartAttributes.fromJson(Map<String, dynamic> json) {
    final productJson = json[ArgumentName.product] as Map<String, dynamic>;
    return RemoveFromCartAttributes(
