/*
 * 
 * remove_from_wishlist_attributes.dart
...
class RemoveFromWishlistAttributes extends CommerceEvent {
  final Product product;

  RemoveFromWishlistAttributes({
    required this.product,
    super.attributes,
  });

  factory RemoveFromWishlistAttributes.fromJson(Map<String, dynamic> json) {
    final productJson = json[ArgumentName.product] as Map<String, dynamic>;
    return RemoveFromWishlistAttributes(
