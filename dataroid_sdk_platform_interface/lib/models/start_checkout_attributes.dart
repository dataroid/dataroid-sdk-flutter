/*
 * 
 * start_checkout_attributes.dart
...
class StartCheckoutAttributes extends CommerceEvent {
  final int value;
  final String currency;
  int? quantity;

  StartCheckoutAttributes({
    required this.value,
  ...
  factory StartCheckoutAttributes.fromJson(Map<String, dynamic> json) {
    return StartCheckoutAttributes(
