...
class ToggleChangeAttributes extends ComponentAttributes {
  ...
  factory ToggleChangeAttributes.fromJson(Map<String, dynamic> json) {
    return ToggleChangeAttributes(
      label: json[ArgumentName.label],
      isChecked: json[ArgumentName.value] ?? false,
