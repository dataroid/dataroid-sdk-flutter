...
class ViewProductAttributes extends CommerceEvent {
  ...
  factory ViewProductAttributes.fromJson(Map<String, dynamic> json) {
    final productJson = json[ArgumentName.product] as Map<String, dynamic>;
    return ViewProductAttributes(
